...
def process_single_random_json(json_dir, output_npy_file=None, matrix_size=64):
    """
...
def generate_house_expo():
    A, map_id = process_single_random_json(json_dir="/home/silvarum/HouseExpo/HouseExpo/json")
