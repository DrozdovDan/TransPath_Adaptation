...
def generate_map(total_area, n_figures, type_ratios, figure_generator, map_size=64):
    """
...
def generate_discrete_map(figures, grid_size=64):
    """
...
def generate_figures(grid_size=64):
    ...
    """
    total_area, n_figures, type_ratios = generate_random_parameters()
    figures = generate_map(total_area, n_figures, type_ratios, figure_generator, map_size=grid_size)
    discrete_map = generate_discrete_map(figures, grid_size=grid_size)
